...
label1 = CTkLabel(master=frame1, text="Welcome back,", font=CTkFont('Microsoft YaHei UI Light',15,"bold"))
label1.place(relx=0.285, rely=0.05)
userlabel = CTkLabel(master=frame1, text="Rakshit Sharma", font=CTkFont('Microsoft YaHei UI Light',30,"bold"))
