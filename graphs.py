...
def bmp_form():
    import forms.bmp_form as bmp_form
...
select_label = CTkLabel(master=frame1, text="Select a form :", font=CTkFont('Microsoft YaHei UI Light',25,"bold"))
...
form1 = CTkButton(master=frame1,text="Basic Blood Chemistry Test",font=CTkFont('Kanit Regular', 20, "bold"),fg_color="#FFFFFF",text_color="#000000",hover_color="#5FBDFF", corner_radius=100)
